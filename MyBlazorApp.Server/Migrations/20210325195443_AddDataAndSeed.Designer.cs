...
namespace MyBlazorApp.Server.Migrations
{
    ...
    [Migration("20210325195443_AddDataAndSeed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBlazorApp.Server.Models.WordStats", b =>
                {
                    ...
                    b.Property<int>("WordLearningState")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WordTester.Data.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WordTester.Data.Models.UserCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WordTester.Data.Models.Word", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyBlazorApp.Server.Models.WordStats", b =>
                {
                    b.HasOne("WordTester.Data.Models.Word", "Word")
                        .WithMany("WordStats")
            ...
            modelBuilder.Entity("WordTester.Data.Models.UserCourse", b =>
                {
                    b.HasOne("WordTester.Data.Models.Course", "Course")
